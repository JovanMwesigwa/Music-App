 ...
 *
 */
import { FontAwesome, EvilIcons, Entypo, Ionicons } from '@expo/vector-icons';
  ...
  return (
    <BottomTab.Navigator
      ...
      <BottomTab.Screen
        ...
        options={{
          title: 'Your Library',
          tabBarIcon: ({ color }) => <Ionicons name="library" color={color} size={30} style={{ marginBottom: -3 }} />,
        }}
      />
      ...
      <BottomTab.Screen
        ...
        options={{
          title: 'Premium',
          tabBarIcon: ({ color }) => <Entypo name="spotify" color={color} size={30} style={{ marginBottom: -3 }} />,
        }}
      />
